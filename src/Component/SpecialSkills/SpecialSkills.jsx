...
const SpecialSkills = () => {
    return (
        <div className='max-w-[1480px] mx-auto px-3 md:px-0'>
            <div className='py-[150px] md:flex justify-center items-center gap-20'>
                ...
                <div>
                    ...
                    <div>
                        <Link to='https://drive.google.com/file/d/1gWNzyJrELswogpJ7Dn-Aj6J0hOiPlDFV/view?usp=sharing'><button className='font-primary text-2xl border md:mt-12 p-3 md:p-6 mt-2 md:px-12 rounded-full bg-[#242734] hover:bg-[#2e303c] text-white'><span className='flex gap-4 items-center'>Get Resume <FaDownload></FaDownload></span></button></Link>
                    </div>
                </div>
                <div className='md:grid gap-5 mt-5 md-mt-0'>
                    <div className="card md:w-[650px] md:grid items-center px-10 font-primary h-36 bg-[#292C39] shadow-xl">
                        <div className="">
